...
<body>
<!--<div class="alert alert-warning text-center m-1" role="alert"> -->
<!--    <marquee> -->
<!--        <i class="fas fa-code"></i>  Admin Pannel is under development! <i class="fas fa-code"></i> -->
<!--    </marquee>-->
<!--</div>-->
